    ...
    <div className="space-y-6 max-w-5xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-ink/60">Generate and download comprehensive financial statements.</p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="rounded-2xl border border-white/10 bg-navy-800/50 p-6 flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-heading text-lg font-semibold text-cream mb-1">Profit & Loss Statement</h3>
            <p className="text-sm text-ink/60 mb-4">Detailed P&L statement for the current fiscal year.</p>
        ...
        <div className="rounded-2xl border border-white/10 bg-navy-800/50 p-6 flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-heading text-lg font-semibold text-cream mb-1">Tax Remittance Log</h3>
            <p className="text-sm text-ink/60 mb-4">Record of all VAT and WHT remitted to tax authorities.</p>
            <button className="flex items-center gap-2 text-sm font-medium text-gold-400 hover:text-gold-300 transition-colors">
        ...
        <div className="rounded-2xl border border-white/10 bg-navy-800/50 p-6 flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-heading text-lg font-semibold text-cream mb-1">Revenue by State</h3>
            <p className="text-sm text-ink/60 mb-4">Geographic breakdown of platform revenue and fees.</p>
            <button className="flex items-center gap-2 text-sm font-medium text-gold-400 hover:text-gold-300 transition-colors">
