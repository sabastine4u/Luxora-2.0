    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-ink/60">Manage your active listings and track performance.</p>
        </div>
        <GoldButton>Add New Listing</GoldButton>
      </div>
              ...
              <div>
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="text-right">
                    ...
                    <span className="inline-block mt-1 rounded-full bg-emerald-400/10 border border-emerald-400/20 px-2 py-0.5 text-[10px] font-semibold text-emerald-400">Active</span>
                  </div>
                </div>
              </div>
              
              <div className="grid grid-cols-3 gap-4 mt-4 py-4 border-y border-white/5">
                <div className="flex flex-col items-center">
                  <span className="flex items-center gap-1 text-sm text-ink/50"><Eye className="h-4 w-4" /> Views</span>
                  <span className="font-semibold text-cream mt-1">4.2k</span>
                </div>
                <div className="flex flex-col items-center border-l border-white/5">
                  <span className="flex items-center gap-1 text-sm text-ink/50"><Heart className="h-4 w-4" /> Saves</span>
                  <span className="font-semibold text-cream mt-1">318</span>
                </div>
                <div className="flex flex-col items-center border-l border-white/5">
                  <span className="flex items-center gap-1 text-sm text-ink/50"><Key className="h-4 w-4" /> Viewings</span>
                  <span className="font-semibold text-cream mt-1">12</span>
                </div>
              </div>
              
              <div className="mt-4 flex gap-3">
                <GhostButton size="sm">Edit Listing</GhostButton>
                <GhostButton size="sm">View Analytics</GhostButton>
              </div>
            </div>
          </div>
        ))}
