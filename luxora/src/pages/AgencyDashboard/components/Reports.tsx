...
export default function Reports() {
  const reports = [
    { name: 'Agency Q3 2025 Financials', date: 'Oct 1, 2025', size: '4.2 MB' },
    { name: 'Agent Performance Leaderboard', date: 'Oct 1, 2025', size: '1.8 MB' },
    { name: 'September Listings Activity', date: 'Oct 1, 2025', size: '2.1 MB' },
    { name: 'Q2 2025 Financials', date: 'Jul 1, 2025', size: '4.1 MB' },
  ];
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="font-heading text-2xl font-bold text-cream">Firm Reports</h2>
          <p className="text-sm text-ink/60">Generate and export agency-wide analytics and financials.</p>
        </div>
