import { User, Mail, Bell, Shield, KeyRound, Smartphone } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-sm text-ink/60">Manage your profile, security, and preferences.</p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-2xl border border-white/10 bg-navy-800/50 p-6 space-y-4">
            ...
            {[
              { label: 'Email Alerts', desc: 'New properties, price drops', icon: Mail, on: true },
              { label: 'Push Notifications', desc: 'Message alerts, viewing updates', icon: Bell, on: true },
              { label: 'SMS Updates', desc: 'Offer status, urgent alerts', icon: Smartphone, on: false },
            ].map((pref, i) => (
