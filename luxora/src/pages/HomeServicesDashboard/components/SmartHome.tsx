import { Wifi, Star, Search, ShieldCheck } from 'lucide-react';
import { GoldButton } from '../../../components/ui/ui';

export default function SmartHome() {
  const providers = [
    { id: 'SMT-1', name: 'NextGen Automation', rating: '4.9', reviews: 145, price: 'Custom Quote', tags: ['Lighting', 'Audio/Video', 'Climate'] },
    { id: 'SMT-2', name: 'SmartSpace Integrators', rating: '4.7', reviews: 88, price: 'From ₦500,000/system', tags: ['Full Home', 'Retrofit'] },
  ];
  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="font-heading text-2xl font-bold text-cream">Smart Home Integrations</h2>
          <p className="text-sm text-ink/60">Automate your home with cutting-edge technology installers.</p>
        </div>
      </div>
