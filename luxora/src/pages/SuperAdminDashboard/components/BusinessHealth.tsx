  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="font-heading text-2xl font-bold text-cream">Business Health</h2>
          <p className="text-sm text-ink/60">Executive overview of platform vitality and core KPIs.</p>
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="rounded-2xl border border-white/10 bg-navy-800/50 p-6">
          ...
          <div className="text-sm text-ink/60 mb-1">Total Users</div>
        ...
        <div className="rounded-2xl border border-white/10 bg-navy-800/50 p-6">
          ...
          <div className="text-sm text-ink/60 mb-1">Daily Active Users (DAU)</div>
          <div className="font-heading text-3xl font-bold text-cream">45.2K</div>
          <div className="text-xs text-emerald-400 mt-2 flex items-center gap-1"><ArrowUpRight className="h-3 w-3" /> +5% MoM</div>
        </div>
        <div className="rounded-2xl border border-white/10 bg-navy-800/50 p-6">
