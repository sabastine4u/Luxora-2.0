  ...
  return (
    <div className="space-y-6 max-w-5xl">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h2 className="font-heading text-2xl font-bold text-cream">Vendor Details: <span className="text-gold-400">Global Tech Supplies</span></h2>
          <p className="text-sm text-ink/60">ID: VND-001 • Category: IT Hardware</p>
        </div>
        <div className="flex gap-2">
          <GhostButton>Suspend Vendor</GhostButton>
