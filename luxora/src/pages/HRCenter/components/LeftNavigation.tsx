import { LayoutDashboard, Users, UserPlus, Clock, CalendarDays, Target, Banknote, GraduationCap, Network, Laptop, Award, PieChart, Sparkles } from 'lucide-react';
import { useHRCenter } from '../hooks/useHRCenter';
import { HR_NAVIGATION, type HRWorkspace } from '../constants/hrConstants';
...
export const LeftNavigation = () => {
  const { activeWorkspace, setActiveWorkspace } = useHRCenter();
      ...
      <div className="p-4 space-y-1">
        {HR_NAVIGATION.map((nav) => {
          ...
          return (
            <button
              key={nav.id}
              onClick={() => setActiveWorkspace(nav.id as HRWorkspace)}
